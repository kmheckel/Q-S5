...
python run_qtrain.py \
    ...
    $args \
    --dataset=aan-classification \
    --n_layers=6 --d_model=128 --ssm_size_base=256 --blocks=16 \
    --prenorm=True --bsz=32 --epochs=20 \
    --ssm_lr_base=0.001 --lr_factor=2 --p_dropout=0.0 --weight_decay=0.05 \
    --jax_seed=5464368 \
    --C_init=trunc_standard_normal --bidirectional=True \
    --opt_config=standard \
    --warmup_end=1 \
    --dt_global=True