...
#     --use_qlayernorm_if_quantized=True --hard_sigmoid --qgelu_approx \
#     --run_name=listops-qaa-W4A8Wssm8
...
#     --use_qlayernorm_if_quantized=True --hard_sigmoid --qgelu_approx \
#     --run_name=listops-qaa-W2A8Wssm8
